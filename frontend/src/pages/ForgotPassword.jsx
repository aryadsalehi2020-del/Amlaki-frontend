          ...
          {sent ? (
            <div className="text-center">
              ...
              <p className="text-[14px] text-[#8C7E6A] mb-6">
                Falls ein Account mit dieser E-Mail existiert, haben wir dir einen Reset-Link gesendet. Pruefe auch deinen Spam-Ordner.
              </p>
            ...
            <>
              ...
              <p className="text-[13px] text-[#8C7E6A] text-center mb-6">
                Gib deine E-Mail ein und wir senden dir einen Link zum Zuruecksetzen.
              </p>
              ...
              <p className="mt-6 text-center text-[13px] text-[#8C7E6A]">
                <Link to="/login" className="text-[#7C8B6F] hover:text-[#6B7A5E] font-medium transition-colors">Zurueck zum Login</Link>
              </p>
            </>
          )}
        </div>
